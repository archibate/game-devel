...
function step() {
	ps.emit(new Particle(new Vector2(200, 200), sampleDirection(Math.PI * 1.75, Math.PI * 2).multiply(100), sampleColor(Color.blue, Color.purple), 5));
		ps.simulate(dt);
		clearCanvas();
		ps.render(ctx);
}
