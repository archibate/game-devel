...
class Mat3_old(Vec3):
    ...
    def rev(self):
        return type(self)(self).irev()

    def __repr__(self):
        return "Mat3_old(%s, %s, %s)" % (self.x, self.y, self.z)
#
#def showval(s):
    #print(s, eval(s))
#
#v = Vec3(1, 2, 3)
#M = Mat3(Vec3(1,0,0), Vec3(0,1,0), Vec3(0,0,0.5))
#T = Mat3(Vec3(1,0,0), Vec3(0,1,0), Vec3(0,0.5,0.5))
#showval("M*T				")
#showval("v				")
#showval("T.dot(v)			")
#showval("M*T				")
#showval("(M*T.rev()).dot(v)		")
